 ...
 *         &lt;element name="SuppCode" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "clsBookRS")
public class ClsBookRS {

    @XmlElement(name = "OpResult")
    protected ClsResultType opResult;
    @XmlElement(name = "SuppCode")
