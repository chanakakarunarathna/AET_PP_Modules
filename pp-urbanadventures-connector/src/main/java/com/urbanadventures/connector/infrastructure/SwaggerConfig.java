...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.urbanadventures.connector.controller"))
	...
	private ApiInfo apiInfo() {
		...
		return new ApiInfoBuilder().title("PP Product Service")
				.description("PP Product Service Described!!")
