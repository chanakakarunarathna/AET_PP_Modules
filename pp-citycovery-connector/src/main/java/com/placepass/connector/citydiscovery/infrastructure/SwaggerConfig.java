...
public class SwaggerConfig {
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName("placepass-api").select()
                .apis(RequestHandlerSelectors.basePackage("com.placepass.connector.citydiscovery.controller"))
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfoBuilder().title("PP Product Service").description("PP Product Service Described!!")
