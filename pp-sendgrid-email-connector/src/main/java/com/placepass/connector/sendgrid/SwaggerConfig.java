...
public class SwaggerConfig {
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName("placepass-api").select()
                .apis(RequestHandlerSelectors.basePackage("com.placepass.connector.sendgrid.controller"))
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfoBuilder().title("Sendgrid Email Connector").description("Sendgrid Email Connector API Documentation")
