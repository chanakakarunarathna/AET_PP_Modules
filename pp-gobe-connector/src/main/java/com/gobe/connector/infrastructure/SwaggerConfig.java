...
public class SwaggerConfig {
    ...
    public Docket api() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).groupName("placepass-api").select()
                .apis(RequestHandlerSelectors.basePackage("com.gobe.connector.controller"))
    ...
    private ApiInfo apiInfo() {
        ...
        return new ApiInfoBuilder().title("PP Gobe Connector").description("PP Gobe Connector Described!!")
    ...
    @Bean
    public Docket gobeApi() {

        return new Docket(DocumentationType.SWAGGER_2).groupName("placepass-gobe-api").select()
                .apis(RequestHandlerSelectors.basePackage("com.gobe.connector.gobecontroller"))
                .paths(PathSelectors.any()).build().apiInfo(gobeApiInfo());

    }

    private ApiInfo gobeApiInfo() {

        return new ApiInfoBuilder().title("Gobe Endpoint API")
                .description("Gobe Endpoint API Documentation")
